...
export const Formats: import('../sim/dex-formats').FormatList = [
    ...
    },
	{
		...
		banlist: [
			'ND Uber', 'ND AG', 'Arena Trap', 'Moody', 'Power Construct', 'Shadow Tag', 'King\'s Rock',
			'Quick Claw', 'Razor Fang', 'Assist', 'Baton Pass', 'Last Respects', 'Shed Tail',
			'Rage Fist', 'Return', 'Frustration',
		],
	},
	{
		name: "[Gen 9] Wordmons OU",
		mod: 'gen9wordmons',
		ruleset: ['Standard NatDex', 'Terastal Clause', 'Z-Move Clause', 'Data Mod', '+Nonexistent'],
		banlist: [
			'ND Uber', 'ND AG',
		],
	},
	{
		...
		gameType: "triples",
		mod: 'buildmons',
		ruleset: ['Standard NatDex', 'Data Mod', 'Open Team Sheets', 'Sleep Moves Clause', 'Max Total Level = 400', 'Item Clause = 1', 'Ability Clause = 1'],
	...
	},
	{
		...
		onValidateSet(set) {
			...
			// Validate moves with nonsky flag
			for (const move of set.moves) {
				const moveData = this.dex.moves.get(move);
				if (moveData.flags && moveData.flags.nonsky) {
					return [`${species.name} has a move that is not allowed in Sky Battles.`, `(${moveData.name} is banned due to the nonsky flag.)`];
				}
			}
		}
	},
	{
		...
		mod: 'gen9',
		ruleset: ['Standard NatDex', 'Terastal Clause', 'Inverse Mod'],
		banlist: [
			'ND Uber', 'ND AG', 'Arena Trap', 'Moody', 'Power Construct', 'Shadow Tag', 'King\'s Rock',
			'Quick Claw', 'Razor Fang', 'Assist', 'Baton Pass', 'Last Respects', 'Shed Tail',
			'Lopunny-Mega'
