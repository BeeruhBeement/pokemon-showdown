export const Pokedex: {[speciesid: string]: SpeciesData} = {
	...
	bastiodonmega: {
		...
		forme: "Mega",
		types: ["Rock", "Steel"],
		baseStats: {hp: 60, atk: 82, def: 188, spa: 67, spd: 168, spe: 30},
		abilities: {0: "Tough Claws"},
		heightm: 1.4,
		weightkg: 449.5,
		color: "Gray",
	...
	monki: {
		...
		name: "Monki",
		types: ["Grass", "Fire"],
		baseStats: {hp: 85, atk: 120, def: 85, spa: 75, spd: 75, spe: 76},
		abilities: {0: "Sheer Force"},
		heightm: 1.5,
		weightkg: 81,
		color: "Green",
	...
	toxicombat: {
		...
		name: "Toxicombat",
		types: ["Poison", "Fighting"],
		baseStats: {hp: 75, atk: 80, def: 50, spa: 105, spd: 90, spe: 80},
		abilities: {0: "Poison Point", 1: "Neutralizing Gas"},
		heightm: 1.8,
		weightkg: 61,
		color: "White",
		eggGroups: ["Amorphous"],
