export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	kisscope: {
		...
		types: ["Ice", "Psychic"],
		gender: "F",
		baseStats: {hp: 70, atk: 60, def: 45, spa: 135, spd: 100, spe: 95},
		abilities: {0: "Skill Link", 1: "Sniper", H: "Dry Skin"},
		heightm: 1.5,
		weightkg: 60.6,
		color: "Red",
		prevo: "Jynx",
	...
	ironmongrel: {
		...
		types: ["Dark", "Electric"],
		gender: "N",
		baseStats: {hp: 74, atk: 116, def: 68, spa: 80, spd: 100, spe: 132},
		abilities: {0: "Quark Drive"},
		heightm: 1.3,
		weightkg: 50,
		color: "Gray",
	...
	vibraye: {
		...
		name: "Vibraye",
		types: ["Dark"],
		baseStats: {hp: 93, atk: 76, def: 73, spa: 83, spd: 113, spe: 45},
	...
	setuppoison: {
		// bulk up poison setup sweeper with mirror armor
		isNonstandard: "Custom",
		num: -10004,
		name: "Setup Poison",
		types: ["Poison", "Fairy"],
		baseStats: {hp: 65, atk: 108, def: 95, spa: 65, spd: 75, spe: 112},
		abilities: {0: "Mirror Armor", H: "Poison Point"},
		heightm: 1.8,
		weightkg: 55,
		color: "Purple",
		eggGroups: ["Human-Like"],
	...
	variengo: {
		...
		types: ["Steel", "Fighting"],
		gender: "N",
		baseStats: { hp: 91, atk: 133, def: 95, spa: 87, spd: 84, spe: 60 },
		abilities: { 0: "Clear Body", H: "Kleptomancy" },
		heightm: 1.2,
		weightkg: 30,
		color: "Gray",
		prevo: "Gimmighoul",
		evoType: "other",
		evoCondition: "Level up while holding a Metal Coat and above level 50",
		eggGroups: ["Undiscovered"],
	},
};