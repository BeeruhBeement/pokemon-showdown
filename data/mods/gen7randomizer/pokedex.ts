...
export const Pokedex: {[k: string]: ModdedSpeciesData} = {
	bulbasaur: {
		inherit: true,
		types: ["Flying"],
		baseStats: {hp: 71, atk: 23, def: 56, spa: 86, spd: 30, spe: 51},
	...
	ivysaur: {
		inherit: true,
		types: ["Poison"],
		baseStats: {hp: 73, atk: 42, def: 101, spa: 90, spd: 60, spe: 38},
		abilities: {0: "Cheek Pouch", H: "Unnverve"},
		prevo: "",
		evos: ["Charizard-Mega-Y"],
	},
	venusaur: {
		num: 3,
		name: "Venusaur",
	...
	greninja: {
		inherit: true,
		types: ["Water", "Fairy"],
		baseStats: {hp: 174, atk: 75, def: 137, spa: 46, spd: 56, spe: 41},
		abilities: {0: "Sand Stream", 1: "Flower Veil", H: "Soundproof"},
		prevo: "Dartrix",
	},
	greninjabond: {
		num: 658,
	...
	dartrix: {
		inherit: true,
		types: ["Psychic"],
		baseStats: {hp: 67, atk: 99, def: 72, spa: 14, spd: 78, spe: 90},
		abilities: {0: "Damp", H: "Psychic Surge"},
		prevo: "Bulbasaur",
		evos: ["Greninja"],
	},
	decidueye: {
