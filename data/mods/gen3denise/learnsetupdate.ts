...
export function learnsetUpdate(dex: ModdedDex) {
	dex.modData("Learnsets", "bulbasaur").learnset.leafstorm = ["3E"];

	dex.modData("Learnsets", "charizard").learnset.acrobatics = ["3L1"];
	dex.modData("Learnsets", "charizard").learnset.dualwingbeat = ["3T"];

	dex.modData("Learnsets", "squirtle").learnset.zapcannon = ["3E"];
	dex.modData("Learnsets", "squirtle").learnset.lifedew = ["3E"];
	dex.modData("Learnsets", "blastoise").learnset.zapcannon = ["3L1"];
	dex.modData("Learnsets", "blastoise").learnset.zapbarrage = ["3L1"];
	dex.modData("Learnsets", "blastoise").learnset.steelroller = ["3T"];
	dex.modData("Learnsets", "blastoise").learnset.scald = ["3T"];

	dex.modData("Learnsets", "butterfree").learnset.quiverdance = ["3L46"];
	dex.modData("Learnsets", "butterfree").learnset.encore = ["3L53"];
	dex.modData("Learnsets", "butterfree").learnset.tailwind = ["3L61"];
	dex.modData("Learnsets", "butterfree").learnset.energyball = ["3M"];
	dex.modData("Learnsets", "butterfree").learnset.dualwingbeat = ["3T"];
	...
	dex.modData("Learnsets", "beedrill").learnset.irontail = ["3M"];
	
	dex.modData("Learnsets", "pidgey").learnset.roost = ["3L57"];
	dex.modData("Learnsets", "pidgey").learnset.dualwingbeat = ["3T"];
	dex.modData("Learnsets", "pidgeotto").learnset.roost = ["3L42"];
	dex.modData("Learnsets", "pidgeotto").learnset.dualwingbeat = ["3T"];
	dex.modData("Learnsets", "pidgeot").learnset.heatwave = ["3L1"];
	...
	dex.modData("Learnsets", "ekans").learnset.switcheroo = ["3E"];
	dex.modData("Learnsets", "ekans").learnset.gunkshot = ["3L41"];
	dex.modData("Learnsets", "ekans").learnset.coil = ["3L44"];
	dex.modData("Learnsets", "arbok").learnset.gunkshot = ["3L56"];
	dex.modData("Learnsets", "arbok").learnset.coil = ["3L56"];

	dex.modData("Learnsets", "pichu").learnset.nastyplot = ["3L18"];
	dex.modData("Learnsets", "pikachu").learnset.discharge = ["3L37"];

	dex.modData("Learnsets", "sandshrew").learnset.spikes = ["3E"];
	dex.modData("Learnsets", "sandshrew").learnset.rapidspin = ["3L13"];
	dex.modData("Learnsets", "sandshrew").learnset.stealthrock = ["3M"];
	dex.modData("Learnsets", "sandshrew").learnset.steelroller = ["3T"];
	dex.modData("Learnsets", "sandslash").learnset.rapidspin = ["3L13"];
	dex.modData("Learnsets", "sandslash").learnset.stealthrock = ["3M"];
	dex.modData("Learnsets", "sandslash").learnset.rockclimb = ["3M"];
	dex.modData("Learnsets", "sandslash").learnset.steelroller = ["3T"];
	
	dex.modData("Learnsets", "nidoranf").learnset.lovelykiss = ["3E"];
	dex.modData("Learnsets", "nidoqueen").learnset.rockclimb = ["3M"];

	dex.modData("Learnsets", "nidoranm").learnset.lovelykiss = ["3E"];
	dex.modData("Learnsets", "nidoranm").learnset.headsmash = ["3E"];
	dex.modData("Learnsets", "nidoking").learnset.rockclimb = ["3M"];
	
	dex.modData("Learnsets", "clefairy").learnset.spotlight = ["3L1"];
	dex.modData("Learnsets", "clefairy").learnset.lifedew = ["3L16"];
	dex.modData("Learnsets", "clefairy").learnset.wakeupslap = ["3L22"];
	dex.modData("Learnsets", "clefairy").learnset.dazzlinggleam = ["3M"];
	dex.modData("Learnsets", "clefairy").learnset.dualwingbeat = ["3T"];
	dex.modData("Learnsets", "clefairy").learnset.teleport = ["3M"];
	dex.modData("Learnsets", "clefable").learnset.spotlight = ["3L1"];
	dex.modData("Learnsets", "clefable").learnset.lifedew = ["3L1"];
	dex.modData("Learnsets", "clefable").learnset.dazzlinggleam = ["3M"];
	dex.modData("Learnsets", "clefable").learnset.dualwingbeat = ["3T"];
	dex.modData("Learnsets", "clefable").learnset.teleport = ["3M"];

	dex.modData("Learnsets", "vulpix").learnset.solarbeam = ["3M"];
	dex.modData("Learnsets", "vulpix").learnset.weatherball = ["3T"];
	dex.modData("Learnsets", "ninetales").learnset.dazzlinggleam = ["3M", "3L1"];
	dex.modData("Learnsets", "ninetales").learnset.nastyplot = ["3L1"];
	dex.modData("Learnsets", "ninetales").learnset.solarbeam = ["3M"];
	dex.modData("Learnsets", "ninetales").learnset.weatherball = ["3T"];

	dex.modData("Learnsets", "jigglypuff").learnset.wakeupslap = ["3L37"];
	dex.modData("Learnsets", "jigglypuff").learnset.dazzlinggleam = ["3M"];
	dex.modData("Learnsets", "jigglypuff").learnset.selfdestruct = ["3T"];
	dex.modData("Learnsets", "wigglytuff").learnset.dazzlinggleam = ["3M"];
	dex.modData("Learnsets", "wigglytuff").learnset.selfdestruct = ["3T"];
	...
	dex.modData("Learnsets", "oddish").learnset.strengthsap = ["3E"];
	dex.modData("Learnsets", "bellossom").learnset.quiverdance = ["3L39"];
	dex.modData("Learnsets", "bellossom").learnset.leafstorm = ["3L53"];

	dex.modData("Learnsets", "paras").learnset.xscissor = ["3T", "3L43"];
	dex.modData("Learnsets", "parasect").learnset.xscissor = ["3T"];
	dex.modData("Learnsets", "parasect").learnset.shadowball = ["3L55", "3M"];
	
	dex.modData("Learnsets", "venonat").learnset.morningsun = ["3E"];
	dex.modData("Learnsets", "venomoth").learnset.quiverdance = ["3L63"];
	
	dex.modData("Learnsets", "diglett").learnset.swordsdance = ["3T"];
	dex.modData("Learnsets", "dugtrio").learnset.nightslash = ["3L1"];
	dex.modData("Learnsets", "dugtrio").learnset.swordsdance = ["3T"];
	...
	dex.modData("Learnsets", "arcanine").learnset.teleport = ["3T"];
	
	dex.modData("Learnsets", "poliwag").learnset.lovelykiss = ["3E"];
	dex.modData("Learnsets", "poliwag").learnset.wakeupslap = ["3L35"];
	dex.modData("Learnsets", "poliwag").learnset.scald = ["3T"];
	dex.modData("Learnsets", "poliwhirl").learnset.wakeupslap = ["3L43"];
	dex.modData("Learnsets", "poliwhirl").learnset.scald = ["3T"];
	dex.modData("Learnsets", "poliwrath").learnset.circlethrow = ["3L53"];
	dex.modData("Learnsets", "poliwrath").learnset.rockclimb = ["3M"];
	...
	dex.modData("Learnsets", "machop").learnset.wakeupslap = ["3L34"];
	dex.modData("Learnsets", "machop").learnset.drainpunch = ["3T"];
	dex.modData("Learnsets", "machoke").learnset.machpunch = ["3L22"];
	dex.modData("Learnsets", "machoke").learnset.wakeupslap = ["3L36"];
	dex.modData("Learnsets", "machoke").learnset.drainpunch = ["3T"];
	dex.modData("Learnsets", "machamp").learnset.machpunch = ["3L22"];
	dex.modData("Learnsets", "machamp").learnset.drainpunch = ["3T","3L30"];
	dex.modData("Learnsets", "machamp").learnset.wakeupslap = ["3L36"];
	
	dex.modData("Learnsets", "bellsprout").learnset.strengthsap = ["3E"];
	dex.modData("Learnsets", "bellsprout").learnset.weatherball = ["3E"];
	dex.modData("Learnsets", "victreebel").learnset.suckerpunch = ["3L1"];
	dex.modData("Learnsets", "victreebel").learnset.leafstorm = ["3L47"];
	
	dex.modData("Learnsets", "geodude").learnset.rapidspin = ["3E"];
	dex.modData("Learnsets", "geodude").learnset.rockpolish = ["3L8"];
	...
	dex.modData("Learnsets", "onix").learnset.dragondance = ["3L49"];
	dex.modData("Learnsets", "onix").learnset.rockclimb = ["3M"];
	dex.modData("Learnsets", "onix").learnset.stealthrock = ["3M"];
	dex.modData("Learnsets", "steelix").learnset.rockpolish = ["3L30"];
	...
	dex.modData("Learnsets", "drowzee").learnset.wakeupslap = ["3L29"];
	dex.modData("Learnsets", "drowzee").learnset.nastyplot = ["3L43"];
	dex.modData("Learnsets", "hypno").learnset.wakeupslap = ["3L29"];
	dex.modData("Learnsets", "hypno").learnset.nastyplot = ["3L55"];
	
	dex.modData("Learnsets", "krabby").learnset.xscissor = ["3T"];
	dex.modData("Learnsets", "kingler").learnset.superpower = ["3L1"];
	dex.modData("Learnsets", "kingler").learnset.xscissor = ["3T"];
	
	dex.modData("Learnsets", "voltorb").learnset.hypervoice = ["3L56"];
	dex.modData("Learnsets", "voltorb").learnset.voltswitch = ["3L78"];
	dex.modData("Learnsets", "electrode").learnset.hypervoice = ["3L50"];
	dex.modData("Learnsets", "electrode").learnset.voltswitch = ["3L62"];
	...
	dex.modData("Learnsets", "tyrogue").learnset.fakeout = ["3L1"];
	...
	dex.modData("Learnsets", "hitmonchan").learnset.drainpunch = ["3T"];
	dex.modData("Learnsets", "hitmonchan").learnset.suckerpunch = ["3T"];
	dex.modData("Learnsets", "hitmonchan").learnset.poweruppunch = ["3T"];
	dex.modData("Learnsets", "hitmontop").learnset.suckerpunch = ["3T"];
	dex.modData("Learnsets", "hitmontop").learnset.poweruppunch = ["3T"];

	dex.modData("Learnsets", "weezing").learnset.heatwave = ["3L1"];

	dex.modData("Learnsets", "rhyhorn").learnset.stealthrock = ["3M"];
	dex.modData("Learnsets", "rhydon").learnset.stealthrock = ["3M"];

	dex.modData("Learnsets", "chansey").learnset.lifedew = ["3L12"];
	dex.modData("Learnsets", "blissey").learnset.lifedew = ["3L12"];
	
	dex.modData("Learnsets", "tangela").learnset.leafstorm = ["3E"];
	dex.modData("Learnsets", "tangela").learnset.wakeupslap = ["3E"];
	dex.modData("Learnsets", "tangela").learnset.energyball = ["3M"];
	
	dex.modData("Learnsets", "kangaskhan").learnset.wish = ["3E"];
	dex.modData("Learnsets", "kangaskhan").learnset.yawn = ["3E"];
	dex.modData("Learnsets", "kangaskhan").learnset.suckerpunch = ["3T", "3L46"];
	dex.modData("Learnsets", "kangaskhan").learnset.rockclimb = ["3M"];
	dex.modData("Learnsets", "kangaskhan").learnset.drainpunch = ["3T"];
	
	dex.modData("Learnsets", "horsea").learnset.outrage = ["3E"];
	dex.modData("Learnsets", "kingdra").learnset.hurricane = ["3L57"];
	...
	dex.modData("Learnsets", "starmie").learnset.scald = ["3T"];
	dex.modData("Learnsets", "starmie").learnset.teleport = ["3T"];
	
	dex.modData("Learnsets", "mrmime").learnset.nastyplot = ["3E"];
	dex.modData("Learnsets", "mrmime").learnset.wakeupslap = ["3E"];
	dex.modData("Learnsets", "mrmime").learnset.dazzlinggleam = ["3M"];
	...
	dex.modData("Learnsets", "scyther").learnset.dualwingbeat = ["3T"];
	dex.modData("Learnsets", "scizor").learnset.bulletpunch = ["3L1"];
	dex.modData("Learnsets", "scizor").learnset.uturn = ["3T"];
	dex.modData("Learnsets", "scizor").learnset.xscissor = ["3T"];
	dex.modData("Learnsets", "scizor").learnset.nightslash = ["3L45"];

	dex.modData("Learnsets", "smoochum").learnset.miracleeye = ["3E"];
	dex.modData("Learnsets", "smoochum").learnset.nastyplot = ["3E"];
	dex.modData("Learnsets", "smoochum").learnset.heartstamp = ["3L21"];
	dex.modData("Learnsets", "jynx").learnset.drainingkiss = ["3L1"];
	dex.modData("Learnsets", "jynx").learnset.heartstamp = ["3L21"];
	dex.modData("Learnsets", "jynx").learnset.wakeupslap = ["3L28"];
	dex.modData("Learnsets", "jynx").learnset.deepfreeze = ["3L60"];
	...
	dex.modData("Learnsets", "tauros").learnset.temperflare = ["3L1"];
	dex.modData("Learnsets", "tauros").learnset.ragingbull = ["3L35"];
	dex.modData("Learnsets", "tauros").learnset.rockclimb = ["3M"];
	
	dex.modData("Learnsets", "magikarp").learnset.bounce = ["3L50"];
	...
	dex.modData("Learnsets", "porygon").learnset.discharge = ["3L40"];
	dex.modData("Learnsets", "porygon2").learnset.discharge = ["3L40"];
	...
	dex.modData("Learnsets", "kabuto").learnset.knockoff = ["3L60", "3E"];
	dex.modData("Learnsets", "kabuto").learnset.leechlife = ["3L48"];
	dex.modData("Learnsets", "kabutops").learnset.stealthrock = ["3M"];
	dex.modData("Learnsets", "kabutops").learnset.knockoff = ["3L72"];
	dex.modData("Learnsets", "kabutops").learnset.leechlife = ["3L54"];
	dex.modData("Learnsets", "kabutops").learnset.nightslash = ["3L72"];
	...
	dex.modData("Learnsets", "articuno").learnset.dualwingbeat = ["3T"];

	dex.modData("Learnsets", "zapdos").learnset.defog = ["3L1"];
	dex.modData("Learnsets", "zapdos").learnset.discharge = ["3L50"];
	dex.modData("Learnsets", "zapdos").learnset.roost = ["3L57"];
	dex.modData("Learnsets", "zapdos").learnset.heatwave = ["3L78"];
	dex.modData("Learnsets", "zapdos").learnset.uturn = ["3T"];
	dex.modData("Learnsets", "zapdos").learnset.dualwingbeat = ["3T"];

	dex.modData("Learnsets", "moltres").learnset.defog = ["3L1"];
	dex.modData("Learnsets", "moltres").learnset.roost = ["3L57"];
	dex.modData("Learnsets", "moltres").learnset.uturn = ["3T"];
	dex.modData("Learnsets", "moltres").learnset.dualwingbeat = ["3T"];
	
	dex.modData("Learnsets", "dratini").learnset.extremespeed = ["3E"];
	dex.modData("Learnsets", "dratini").learnset.dragontail = ["3L31"];
	dex.modData("Learnsets", "dratini").learnset.dragondance = ["3L45", "3E"];
	dex.modData("Learnsets", "dratini").learnset.coil = ["3L55"];
	dex.modData("Learnsets", "dragonair").learnset.dragontail = ["3L33"];
	dex.modData("Learnsets", "dragonair").learnset.dragondance = ["3L53"];
	dex.modData("Learnsets", "dragonair").learnset.coil = ["3L67"];
	dex.modData("Learnsets", "dragonite").learnset.dragontail = ["3L33"];
	dex.modData("Learnsets", "dragonite").learnset.dragondance = ["3L53"];
	dex.modData("Learnsets", "dragonite").learnset.hurricane = ["3L81"];
	dex.modData("Learnsets", "dragonite").learnset.dualwingbeat = ["3T"];
	
	dex.modData("Learnsets", "mewtwo").learnset.lifedew = ["3L1"];
	dex.modData("Learnsets", "mewtwo").learnset.nastyplot = ["3L93"];
	dex.modData("Learnsets", "mewtwo").learnset.psystrike = ["3L100"];

	dex.modData("Learnsets", "mew").learnset.lifedew = ["3L40"];
	dex.modData("Learnsets", "mew").learnset.nastyplot = ["3L90"];
	dex.modData("Learnsets", "mew").learnset.dazzlinggleam = ["3M"];
	dex.modData("Learnsets", "mew").learnset.weatherball = ["3T"];
	dex.modData("Learnsets", "mew").learnset.uturn = ["3T"];
	dex.modData("Learnsets", "mew").learnset.drainpunch = ["3T"];
	dex.modData("Learnsets", "mew").learnset.suckerpunch = ["3T"];
	dex.modData("Learnsets", "mew").learnset.rockclimb = ["3M"];
	dex.modData("Learnsets", "mew").learnset.stealthrock = ["3M"];
	dex.modData("Learnsets", "mew").learnset.steelroller = ["3T"];
	dex.modData("Learnsets", "mew").learnset.dualwingbeat = ["3T"];
	...
	dex.modData("Learnsets", "mew").learnset.scald = ["3T"];

	dex.modData("Learnsets", "totodile").learnset.dragondance = ["3E"];

	dex.modData("Learnsets", "chikorita").learnset.energyball = ["3M"];
	dex.modData("Learnsets", "bayleef").learnset.energyball = ["3M"];
	dex.modData("Learnsets", "meganium").learnset.dragontail = ["3L66"];
	dex.modData("Learnsets", "meganium").learnset.rockclimb = ["3M"];
	dex.modData("Learnsets", "meganium").learnset.energyball = ["3M"];

	dex.modData("Learnsets", "cyndaquil").learnset.submission = ["3E"];
	dex.modData("Learnsets", "cyndaquil").learnset.lavaplume = ["3L31"];
	dex.modData("Learnsets", "cyndaquil").learnset.eruption = ["3L49"];
	dex.modData("Learnsets", "quilava").learnset.lavaplume = ["3L35"];
	dex.modData("Learnsets", "quilava").learnset.eruption = ["3L57"];
	dex.modData("Learnsets", "quilava").learnset.scorchingsands = ["3L61"];
	dex.modData("Learnsets", "typhlosion").learnset.lavaplume = ["3L35"];
	dex.modData("Learnsets", "typhlosion").learnset.eruption = ["3L57"];
	dex.modData("Learnsets", "typhlosion").learnset.scorchingsands = ["3L75"];
	dex.modData("Learnsets", "typhlosion").learnset.rockclimb = ["3M"];
	
	dex.modData("Learnsets", "sentret").learnset.tidyup = ["3E"];
	dex.modData("Learnsets", "sentret").learnset.suckerpunch = ["3T", "3L31"];
	dex.modData("Learnsets", "furret").learnset.coil = ["3L1"];
	dex.modData("Learnsets", "furret").learnset.suckerpunch = ["3T", "3L36"];
	
	dex.modData("Learnsets", "hoothoot").learnset.agility = ["3E"];
	dex.modData("Learnsets", "hoothoot").learnset.calmmind = ["3E"];
	dex.modData("Learnsets", "hoothoot").learnset.defog = ["3E"];
	...
	dex.modData("Learnsets", "ledyba").learnset.uturn = ["3T"];
	dex.modData("Learnsets", "ledian").learnset.bulletpunch = ["3L1"];
	dex.modData("Learnsets", "ledian").learnset.superpower = ["3L1"];
	dex.modData("Learnsets", "ledian").learnset.meteormash = ["3L1"];
	dex.modData("Learnsets", "ledian").learnset.machpunch = ["3L17"];
	dex.modData("Learnsets", "ledian").learnset.firepunch = ["3T"];
	dex.modData("Learnsets", "ledian").learnset.drainpunch = ["3T"];
	...
	dex.modData("Learnsets", "chinchou").learnset.discharge = ["3L34"];
	dex.modData("Learnsets", "chinchou").learnset.voltswitch = ["3L34"];
	dex.modData("Learnsets", "chinchou").learnset.dazzlinggleam = ["3M"];
	dex.modData("Learnsets", "chinchou").learnset.scald = ["3T"];
	dex.modData("Learnsets", "lanturn").learnset.paraboliccharge = ["3L1"];
	dex.modData("Learnsets", "lanturn").learnset.discharge = ["3L40"];
	dex.modData("Learnsets", "lanturn").learnset.voltswitch = ["3L40"];
	dex.modData("Learnsets", "lanturn").learnset.dazzlinggleam = ["3M"];
	dex.modData("Learnsets", "lanturn").learnset.scald = ["3T"];
	
	dex.modData("Learnsets", "mareep").learnset.discharge = ["3L28"];
	dex.modData("Learnsets", "mareep").learnset.cottonguard = ["3L32"];
	dex.modData("Learnsets", "flaaffy").learnset.discharge = ["3L31"];
	dex.modData("Learnsets", "flaaffy").learnset.cottonguard = ["3L36"];
	dex.modData("Learnsets", "ampharos").learnset.tailglow = ["3L1"];
	dex.modData("Learnsets", "ampharos").learnset.cottonguard = ["3L20"];
	dex.modData("Learnsets", "ampharos").learnset.discharge = ["3L34"];

	dex.modData("Learnsets", "togepi").learnset.lifedew = ["3L8"];
	dex.modData("Learnsets", "togetic").learnset.lifedew = ["3L1"];
	dex.modData("Learnsets", "togetic").learnset.roost = ["3L51"];
	dex.modData("Learnsets", "togetic").learnset.defog = ["3L51"];
	dex.modData("Learnsets", "togetic").learnset.dazzlinggleam = ["3M"];
	...
	dex.modData("Learnsets", "marill").learnset.superpower = ["3L37", "3E"];
	dex.modData("Learnsets", "marill").learnset.scald = ["3T"];
	dex.modData("Learnsets", "azumarill").learnset.superpower = ["3L42"];
	dex.modData("Learnsets", "azumarill").learnset.scald = ["3T"];
	
	dex.modData("Learnsets", "sudowoodo").learnset.meditate = ["3L1"];
	dex.modData("Learnsets", "sudowoodo").learnset.headsmash = ["3L54"];
	...
	dex.modData("Learnsets", "quagsire").learnset.scald = ["3T"];

	dex.modData("Learnsets", "sunflora").learnset.ember = ["3L1"];
	dex.modData("Learnsets", "sunflora").learnset.weatherball = ["3L1"];
	dex.modData("Learnsets", "sunflora").learnset.firespin = ["3L25"];
	dex.modData("Learnsets", "sunflora").learnset.fireblast = ["3L64", "3M"];
	dex.modData("Learnsets", "sunflora").learnset.flamethrower = ["3M"];
	dex.modData("Learnsets", "sunflora").learnset.firepunch = ["3M"];
	dex.modData("Learnsets", "sunflora").learnset.overheat = ["3M"];
	dex.modData("Learnsets", "sunflora").learnset.energyball = ["3M"];
	
	dex.modData("Learnsets", "yanma").learnset.twister = ["3L33"];
	dex.modData("Learnsets", "yanma").learnset.ancientpower = ["3L33"];
	
	dex.modData("Learnsets", "murkrow").learnset.defog = ["3E"];
	dex.modData("Learnsets", "murkrow").learnset.psychoshift = ["3E"];
	dex.modData("Learnsets", "murkrow").learnset.nastyplot = ["3L35"];
	dex.modData("Learnsets", "murkrow").learnset.suckerpunch = ["3T", "3L45"];
	dex.modData("Learnsets", "murkrow").learnset.nightslash = ["3L25"];
	dex.modData("Learnsets", "murkrow").learnset.dualwingbeat = ["3T"];
	...
	dex.modData("Learnsets", "mismagius").learnset.mysticalfire = ["3L1"];
	...
	dex.modData("Learnsets", "unown").learnset.irontail = ["3L1"];
	dex.modData("Learnsets", "unown").learnset.boomburst = ["3L1"];
	dex.modData("Learnsets", "unown").learnset.leafstorm = ["3L1"];
	dex.modData("Learnsets", "unown").learnset.thunder = ["3L1"];
	dex.modData("Learnsets", "unown").learnset.blizzard = ["3L1"];
	dex.modData("Learnsets", "unown").learnset.outrage = ["3L1"];
	dex.modData("Learnsets", "unown").learnset.gunkshot = ["3L1"];
	...
	dex.modData("Learnsets", "heracross").learnset.spikes = ["3E"];
	...
	dex.modData("Learnsets", "sneasel").learnset.pursuit = ["3E"];
	...
	dex.modData("Learnsets", "magcargo").learnset.recover = ["3L23"];
	dex.modData("Learnsets", "magcargo").learnset.lavaplume = ["3L40"];
	dex.modData("Learnsets", "magcargo").learnset.stealthrock = ["3M"];
	
	dex.modData("Learnsets", "piloswine").learnset.iceshard = ["3L1"];
	
	dex.modData("Learnsets", "corsola").learnset.lifedew = ["3L35"];
	dex.modData("Learnsets", "corsola").learnset.stealthrock = ["3M"];
	dex.modData("Learnsets", "corsola").learnset.scald = ["3T"];
	
	dex.modData("Learnsets", "remoraid").learnset.waterspout = ["3E"];
	dex.modData("Learnsets", "remoraid").learnset.zapcannon = ["3E"];
	dex.modData("Learnsets", "remoraid").learnset.zapbarrage = ["3E"];
	...
	dex.modData("Learnsets", "octillery").learnset.scald = ["3T"];
	
	dex.modData("Learnsets", "delibird").learnset.drillpeck = ["3L25"];
	dex.modData("Learnsets", "delibird").learnset.deepfreeze = ["3L50"];
	dex.modData("Learnsets", "delibird").learnset.frostbite = ["3L75"];
	dex.modData("Learnsets", "delibird").learnset.extremespeed = ["3L100"];
	dex.modData("Learnsets", "delibird").learnset.swordsdance = ["3L100"];
	dex.modData("Learnsets", "delibird").learnset.nastyplot = ["3L100"];
	
	dex.modData("Learnsets", "mantine").learnset.signalbeam = ["3L1"];
	dex.modData("Learnsets", "mantine").learnset.hurricane = ["3L1"];
	dex.modData("Learnsets", "mantine").learnset.roost = ["3L1"];
	dex.modData("Learnsets", "mantine").learnset.dualwingbeat = ["3T"];
	...
	dex.modData("Learnsets", "houndour").learnset.nastyplot = ["3E", "3L53"];
	...
	dex.modData("Learnsets", "stantler").learnset.psyshieldbash = ["3E"];
	dex.modData("Learnsets", "stantler").learnset.jumpkick = ["3L43"];
	dex.modData("Learnsets", "stantler").learnset.blizzard = ["3M"];
	dex.modData("Learnsets", "stantler").learnset.icebeam = ["3M"];
	dex.modData("Learnsets", "stantler").learnset.energyball = ["3M"];
	
	dex.modData("Learnsets", "miltank").learnset.wakeupslap = ["3L55"];
	dex.modData("Learnsets", "miltank").learnset.stealthrock = ["3M"];

	dex.modData("Learnsets", "raikou").learnset.discharge = ["3L57"];
	dex.modData("Learnsets", "raikou").learnset.extremespeed = ["3L90"];
	dex.modData("Learnsets", "raikou").learnset.surf = ["3L90"];
	dex.modData("Learnsets", "raikou").learnset.rockclimb = ["3M"];
	dex.modData("Learnsets", "raikou").learnset.charge = ["3L1"];

	dex.modData("Learnsets", "entei").learnset.stompingtantrum = ["3L1"];
	dex.modData("Learnsets", "entei").learnset.temperflare = ["3L1"];
	dex.modData("Learnsets", "entei").learnset.lavaplume = ["3L57"];
	dex.modData("Learnsets", "entei").learnset.extremespeed = ["3L90"];
	dex.modData("Learnsets", "entei").learnset.thunderbolt = ["3L90"];
	dex.modData("Learnsets", "entei").learnset.rockclimb = ["3M"];
	dex.modData("Learnsets", "entei").learnset.sacredfire = ["3L1"];

	dex.modData("Learnsets", "suicune").learnset.extremespeed = ["3L90"];
	dex.modData("Learnsets", "suicune").learnset.flamethrower = ["3L90"];
	dex.modData("Learnsets", "suicune").learnset.rockclimb = ["3M"];
	dex.modData("Learnsets", "suicune").learnset.tailwind = ["3L1"];
	
	dex.modData("Learnsets", "larvitar").learnset.stompingtantrum = ["3L1"];
	dex.modData("Learnsets", "larvitar").learnset.temperflare = ["3L1"];
	dex.modData("Learnsets", "larvitar").learnset.stealthrock = ["3M"];
	dex.modData("Learnsets", "pupitar").learnset.stompingtantrum = ["3L1"];
	dex.modData("Learnsets", "pupitar").learnset.temperflare = ["3L1"];
	dex.modData("Learnsets", "pupitar").learnset.stealthrock = ["3M"];
	dex.modData("Learnsets", "tyranitar").learnset.stompingtantrum = ["3L1"];
	dex.modData("Learnsets", "tyranitar").learnset.temperflare = ["3L1"];
	dex.modData("Learnsets", "tyranitar").learnset.stealthrock = ["3M"];

	dex.modData("Learnsets", "celebi").learnset.lifedew = ["3L40"];
	dex.modData("Learnsets", "celebi").learnset.leafstorm = ["3L82"];
	dex.modData("Learnsets", "celebi").learnset.dazzlinggleam = ["3M"];
	dex.modData("Learnsets", "celebi").learnset.energyball = ["3M"];
	dex.modData("Learnsets", "celebi").learnset.teleport = ["3T"];
	
	dex.modData("Learnsets", "lugia").learnset.teleport = ["3T"];
	
	dex.modData("Learnsets", "hooh").learnset.lifedew = ["3L9"];
	dex.modData("Learnsets", "hooh").learnset.superpower = ["3L57"];
	
	dex.modData("Learnsets", "treecko").learnset.rockslide = ["3T"];
	dex.modData("Learnsets", "grovyle").learnset.rockslide = ["3T"];
	dex.modData("Learnsets", "sceptile").learnset.nightslash = ["3L1"];
	dex.modData("Learnsets", "sceptile").learnset.rockslide = ["3T"];
	
	dex.modData("Learnsets", "blaziken").learnset.highjumpkick = ["3L1"];
	...
	dex.modData("Learnsets", "poochyena").learnset.pursuit = ["3E"];
	dex.modData("Learnsets", "poochyena").learnset.healbell = ["3E"];
	dex.modData("Learnsets", "poochyena").learnset.flamewheel = ["3E"];
	dex.modData("Learnsets", "poochyena").learnset.nastyplot = ["3E"];
	dex.modData("Learnsets", "poochyena").learnset.suckerpunch = ["3E", "3T", "3L49"];
	dex.modData("Learnsets", "mightyena").learnset.suckerpunch = ["3T", "3L62"];
	...
	dex.modData("Learnsets", "lotad").learnset.energyball = ["3M"];
	dex.modData("Learnsets", "lombre").learnset.energyball = ["3M"];
	dex.modData("Learnsets", "ludicolo").learnset.energyball = ["3M"];

	dex.modData("Learnsets", "seedot").learnset.nastyplot = ["3E"];
	dex.modData("Learnsets", "seedot").learnset.suckerpunch = ["3L30", "3T"];
	dex.modData("Learnsets", "nuzleaf").learnset.suckerpunch = ["3L50", "3T"];
	dex.modData("Learnsets", "nuzleaf").learnset.rockslide = ["3T"];
	dex.modData("Learnsets", "shiftry").learnset.tailwind = ["3L1"];
	dex.modData("Learnsets", "shiftry").learnset.nastyplot = ["3L1"];
	dex.modData("Learnsets", "shiftry").learnset.leafstorm = ["3L49"];
	dex.modData("Learnsets", "shiftry").learnset.suckerpunch = ["3T"];
	dex.modData("Learnsets", "shiftry").learnset.rockslide = ["3T"];

	dex.modData("Learnsets", "taillow").learnset.boomburst = ["3E"];

	dex.modData("Learnsets", "wingull").learnset.aircutter = ["3E"];
	dex.modData("Learnsets", "wingull").learnset.roost = ["3L29"];
	dex.modData("Learnsets", "wingull").learnset.weatherball = ["3T"];
	dex.modData("Learnsets", "wingull").learnset.dualwingbeat = ["3T"];
	dex.modData("Learnsets", "pelipper").learnset.roost = ["3L31"];
	dex.modData("Learnsets", "pelipper").learnset.tailwind = ["3L53"];
	dex.modData("Learnsets", "pelipper").learnset.hurricane = ["3L73"];
	dex.modData("Learnsets", "pelipper").learnset.weatherball = ["3T"];
	dex.modData("Learnsets", "pelipper").learnset.dualwingbeat = ["3T"];

	dex.modData("Learnsets", "ralts").learnset.wish = ["3E"];
	dex.modData("Learnsets", "ralts").learnset.synchronoise = ["3E"];
	dex.modData("Learnsets", "ralts").learnset.shadowsneak = ["3E"];
	dex.modData("Learnsets", "ralts").learnset.disarmingvoice = ["3L11"];
	dex.modData("Learnsets", "ralts").learnset.lifedew = ["3L21"];
	dex.modData("Learnsets", "ralts").learnset.drainingkiss = ["3L22"];
	dex.modData("Learnsets", "ralts").learnset.dazzlinggleam = ["3M"];
	dex.modData("Learnsets", "kirlia").learnset.disarmingvoice = ["3L11"];
	dex.modData("Learnsets", "kirlia").learnset.lifedew = ["3L23"];
	dex.modData("Learnsets", "kirlia").learnset.drainingkiss = ["3L23"];
	dex.modData("Learnsets", "kirlia").learnset.dazzlinggleam = ["3M"];
	dex.modData("Learnsets", "gardevoir").learnset.disarmingvoice = ["3L11"];
	dex.modData("Learnsets", "gardevoir").learnset.lifedew = ["3L23"];
	dex.modData("Learnsets", "gardevoir").learnset.drainingkiss = ["3L23"];
	dex.modData("Learnsets", "gardevoir").learnset.mistyterrain = ["3L1"];
	...
	dex.modData("Learnsets", "shroomish").learnset.wakeupslap = ["3E"];
	dex.modData("Learnsets", "breloom").learnset.poweruppunch = ["3T"];

	dex.modData("Learnsets", "nincada").learnset.xscissor = ["3L52", "3T"];
	dex.modData("Learnsets", "nincada").learnset.nightslash = ["3E"];
	dex.modData("Learnsets", "ninjask").learnset.xscissor = ["3T"];
	...
	dex.modData("Learnsets", "whismur").learnset.synchronoise = ["3L41"];
	dex.modData("Learnsets", "loudred").learnset.bite = ["3L20"];
	dex.modData("Learnsets", "loudred").learnset.synchronoise = ["3L51"];
	dex.modData("Learnsets", "exploud").learnset.bite = ["3L20"];
	dex.modData("Learnsets", "exploud").learnset.crunch = ["3L40"];
	...
	dex.modData("Learnsets", "makuhita").learnset.wakeupslap = ["3L34", "3E"];
	dex.modData("Learnsets", "hariyama").learnset.wakeupslap = ["3L42"];
	...
	dex.modData("Learnsets", "nosepass").learnset.discharge = ["3L49"];
	dex.modData("Learnsets", "nosepass").learnset.stealthrock = ["3M"];
	dex.modData("Learnsets", "nosepass").learnset.dazzlinggleam = ["3M"];

	dex.modData("Learnsets", "skitty").learnset.suckerpunch = ["3E"];
	dex.modData("Learnsets", "skitty").learnset.firstimpression = ["3E"];
	dex.modData("Learnsets", "skitty").learnset.zapcannon = ["3E"];
	dex.modData("Learnsets", "skitty").learnset.zapbarrage = ["3E"];
	dex.modData("Learnsets", "skitty").learnset.headsmash = ["3E"];
	dex.modData("Learnsets", "skitty").learnset.superpower = ["3E"];
	dex.modData("Learnsets", "skitty").learnset.futuresight = ["3E"];
	dex.modData("Learnsets", "skitty").learnset.wakeupslap = ["3L29"];
	dex.modData("Learnsets", "delcatty").learnset.flamethrower = ["3M"];
	dex.modData("Learnsets", "delcatty").learnset.fireblast = ["3M"];
	dex.modData("Learnsets", "delcatty").learnset.overheat = ["3M"];
	dex.modData("Learnsets", "delcatty").learnset.earthquake = ["3M"];
	dex.modData("Learnsets", "delcatty").learnset.suckerpunch = ["3T"];

	dex.modData("Learnsets", "sableye").learnset.encore = ["3E"];
	dex.modData("Learnsets", "sableye").learnset.metalburst = ["3E"];
	dex.modData("Learnsets", "sableye").learnset.octazooka = ["3E"];
	dex.modData("Learnsets", "sableye").learnset.shadowsneak = ["3L25"];
	dex.modData("Learnsets", "sableye").learnset.spiritbreak = ["3L61"];
	dex.modData("Learnsets", "sableye").learnset.dazzlinggleam = ["3M"];
	dex.modData("Learnsets", "sableye").learnset.bulkup = ["3M"];
	dex.modData("Learnsets", "sableye").learnset.thunderwave = ["3T"];
	dex.modData("Learnsets", "sableye").learnset.suckerpunch = ["3T"];
	dex.modData("Learnsets", "sableye").learnset.drainpunch = ["3T"];
	dex.modData("Learnsets", "sableye").learnset.teleport = ["3T"];

	dex.modData("Learnsets", "mawile").learnset.spiritbreak = ["3E"];
	dex.modData("Learnsets", "mawile").learnset.superpower = ["3L60"];
	dex.modData("Learnsets", "mawile").learnset.metalburst = ["3L61"];
	dex.modData("Learnsets", "mawile").learnset.dazzlinggleam = ["3M"];
	dex.modData("Learnsets", "mawile").learnset.steelroller = ["3T"];
	dex.modData("Learnsets", "mawile").learnset.suckerpunch = ["3T"];
	dex.modData("Learnsets", "mawile").learnset.drainpunch = ["3T"];

	dex.modData("Learnsets", "aron").learnset.headsmash = ["3E"];
	dex.modData("Learnsets", "aron").learnset.stealthrock = ["3M"];
	dex.modData("Learnsets", "aron").learnset.steelroller = ["3T"];
	dex.modData("Learnsets", "lairon").learnset.stealthrock = ["3M"];
	dex.modData("Learnsets", "lairon").learnset.rockclimb = ["3M"];
	dex.modData("Learnsets", "lairon").learnset.steelroller = ["3T"];
	dex.modData("Learnsets", "aggron").learnset.stealthrock = ["3M"];
	...
	dex.modData("Learnsets", "gulpin").learnset.curse = ["3E"];
	...
	dex.modData("Learnsets", "flygon").learnset.outrage = ["3L1"];
	dex.modData("Learnsets", "flygon").learnset.dragontail = ["3L65"];
	dex.modData("Learnsets", "flygon").learnset.uturn = ["3T"];
	
	dex.modData("Learnsets", "cacnea").learnset.switcheroo = ["3E"];
	dex.modData("Learnsets", "cacnea").learnset.suckerpunch = ["3T", "3L37"];
	dex.modData("Learnsets", "cacnea").learnset.energyball = ["3M"];
	dex.modData("Learnsets", "cacturne").learnset.payback = ["3L1"];
	dex.modData("Learnsets", "cacturne").learnset.punishment = ["3L1"];
	dex.modData("Learnsets", "cacturne").learnset.bulletpunch = ["3L1"];
	dex.modData("Learnsets", "cacturne").learnset.stompingtantrum = ["3L1"];
	dex.modData("Learnsets", "cacturne").learnset.spikyshield = ["3L32"];
	dex.modData("Learnsets", "cacturne").learnset.suckerpunch = ["3T", "3L41"];
	dex.modData("Learnsets", "cacturne").learnset.energyball = ["3M"];
	dex.modData("Learnsets", "cacturne").learnset.drainpunch = ["3T"];

	dex.modData("Learnsets", "swablu").learnset.cottonguard = ["3L40"];
	dex.modData("Learnsets", "altaria").learnset.cottonguard = ["3L46"];
	...
	dex.modData("Learnsets", "solrock").learnset.weatherball = ["3T"];
	
	dex.modData("Learnsets", "corphish").learnset.dragondance = ["3E"];
	dex.modData("Learnsets", "corphish").learnset.xscissor = ["3T"];
	dex.modData("Learnsets", "crawdaunt").learnset.xscissor = ["3T"];

	dex.modData("Learnsets", "baltoy").learnset.moonlight = ["3L53"];
	dex.modData("Learnsets", "baltoy").learnset.scorchingsands = ["3L61"];
	dex.modData("Learnsets", "claydol").learnset.moonlight = ["3L62"];
	dex.modData("Learnsets", "claydol").learnset.scorchingsands = ["3L73"];
	
	dex.modData("Learnsets", "lileep").learnset.stealthrock = ["3M"];
	dex.modData("Learnsets", "lileep").learnset.energyball = ["3M"];
	dex.modData("Learnsets", "cradily").learnset.stealthrock = ["3M"];
	dex.modData("Learnsets", "cradily").learnset.energyball = ["3M"];
	
	dex.modData("Learnsets", "shuppet").learnset.cottonguard = ["3E"];
	dex.modData("Learnsets", "shuppet").learnset.gunkshot = ["3E"];
	dex.modData("Learnsets", "shuppet").learnset.shadowsneak = ["3E", "3L20"];
	dex.modData("Learnsets", "shuppet").learnset.swordsdance = ["3T"];
	dex.modData("Learnsets", "banette").learnset.shadowsneak = ["3L20"];
	dex.modData("Learnsets", "banette").learnset.trick = ["3L66"];
	dex.modData("Learnsets", "banette").learnset.hex = ["3L88"];
	...
	dex.modData("Learnsets", "anorith").learnset.stealthrock = ["3M"];
	dex.modData("Learnsets", "anorith").learnset.knockoff = ["3L55", "3E"];
	dex.modData("Learnsets", "anorith").learnset.xscissor = ["3L61", "3T"];
	dex.modData("Learnsets", "armaldo").learnset.stealthrock = ["3M"];
	dex.modData("Learnsets", "armaldo").learnset.knockoff = ["3L67"];
	dex.modData("Learnsets", "armaldo").learnset.xscissor = ["3L73", "3T"];
	
	dex.modData("Learnsets", "feebas").learnset.scald = ["3T"];
	dex.modData("Learnsets", "milotic").learnset.lifedew = ["3L20"];
	dex.modData("Learnsets", "milotic").learnset.dragontail = ["3L24"];
	dex.modData("Learnsets", "milotic").learnset.scald = ["3T"];
	...
	dex.modData("Learnsets", "castform").learnset.nightfall = ["3M"];

	dex.modData("Learnsets", "kecleon").learnset.recover = ["3E"];
	dex.modData("Learnsets", "kecleon").learnset.nastyplot = ["3E"];
	dex.modData("Learnsets", "kecleon").learnset.shadowsneak = ["3L20"];
	dex.modData("Learnsets", "kecleon").learnset.suckerpunch = ["3T", "3L46"];
	dex.modData("Learnsets", "kecleon").learnset.synchronoise = ["3L58"];
	dex.modData("Learnsets", "kecleon").learnset.stealthrock = ["3M"];
	dex.modData("Learnsets", "kecleon").learnset.weatherball = ["3T"];
	dex.modData("Learnsets", "kecleon").learnset.teleport = ["3T"];
	
	dex.modData("Learnsets", "tropius").learnset.dragondance = ["3E"];
	dex.modData("Learnsets", "tropius").learnset.leafblade = ["3E"];
	dex.modData("Learnsets", "tropius").learnset.bonemerang = ["3E"];
	dex.modData("Learnsets", "tropius").learnset.leafstorm = ["3L1"];
	dex.modData("Learnsets", "tropius").learnset.outrage = ["3L46"];
	dex.modData("Learnsets", "tropius").learnset.energyball = ["3M"];
	dex.modData("Learnsets", "tropius").learnset.dualwingbeat = ["3T"];

	dex.modData("Learnsets", "chimecho").learnset.wish = ["3E"];
	dex.modData("Learnsets", "chimecho").learnset.trick = ["3E"];
	...
	dex.modData("Learnsets", "snorunt").learnset.frostbite = ["3E"];
	...
	dex.modData("Learnsets", "sealeo").learnset.frostbite = ["3L55"];
	dex.modData("Learnsets", "walrein").learnset.frostbite = ["3L65"];

	dex.modData("Learnsets", "huntail").learnset.coil = ["3L45"];
	dex.modData("Learnsets", "huntail").learnset.suckerpunch = ["3T"];
	...
	dex.modData("Learnsets", "luvdisc").learnset.wish = ["3L13"];
	dex.modData("Learnsets", "luvdisc").learnset.heartstamp = ["3L22"];
	dex.modData("Learnsets", "luvdisc").learnset.flipturn = ["3L46"];
	dex.modData("Learnsets", "luvdisc").learnset.lovelykiss = ["3L99"];
	...
	dex.modData("Learnsets", "metang").learnset.drainpunch = ["3T"];
	...
	dex.modData("Learnsets", "kyogre").learnset.flipturn = ["3L80"];
	
	dex.modData("Learnsets", "groudon").learnset.rockpolish = ["3L80"];
	dex.modData("Learnsets", "groudon").learnset.stealthrock = ["3M"];
	
	dex.modData("Learnsets", "rayquaza").learnset.outrage = ["3L65"];
	
	dex.modData("Learnsets", "jirachi").learnset.lifedew = ["3L21"];
	dex.modData("Learnsets", "jirachi").learnset.healingwish = ["3L50"];
	
	dex.modData("Learnsets", "deoxys").learnset.meteormash = ["3L1"];
	dex.modData("Learnsets", "deoxys").learnset.throatchop = ["3L85"];
	dex.modData("Learnsets", "deoxys").learnset.poweruppunch = ["3T"];
}