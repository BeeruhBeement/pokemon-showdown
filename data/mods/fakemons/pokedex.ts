...
export const Pokedex: {[k: string]: ModdedSpeciesData} = {
	...
	marshtompdelta: {
		...
		abilities: { 0: "Poison Point", H: "Illuminate" },
		heightm: 0.7,
		weightkg: 28,
		color: "Purple",
		evoLevel: 16,
	...
	ghoulgash: {
		...
		name: "Ghoulgash",
		types: ["Ghost", "Rock"],
		baseStats: {hp: 55, atk: 115, def: 95, spa: 45, spd: 65, spe: 75},
	...
	polterslice: {
		...
		name: "Polterslice",
		types: ["Ghost", "Rock"],
		baseStats: {hp: 75, atk: 135, def: 105, spa: 55, spd: 85, spe: 75},
		abilities: {0: "Sturdy", H: "Moxie"},
		heightm: 0.6,
		weightkg: 2,
		prevo: "Ghoulgash",
	...
	lumenova: {
		...
		baseStats: {hp: 60, atk: 65, def: 85, spa: 105, spd: 105, spe: 75},
		abilities: {0: "Dazzling", 1: "Lightning Rod", H: "Illuminate"},
		heightm: 1.2,
		weightkg: 40,
		color: "Yellow",
	...
	tishi: {
		...
		baseStats: {hp: 60, atk: 40, def: 80, spa: 60, spd: 80, spe: 20},
		abilities: {0: "Stamina", H: "Infiltrator"},
		heightm: 0.4,
		weightkg: 1,
		color: "Red",
		evoLevel: 25,
	...
	yodojo: {
		...
		name: "Yodojo",
		types: ["Fighting", "Ghost"],
		baseStats: {hp: 60, atk: 60, def: 100, spa: 100, spd: 100, spe: 40},
		abilities: {0: "Stamina", H: "Levitate"},
		heightm: 0.8,
		weightkg: 5,
		color: "Red",
		eggGroups: ["Amorphous"],
	...
	chessquen: {
		...
		name: "Chessquen",
		types: ["Fairy", "Steel"],
		baseStats: {hp: 75, atk: 90, def: 105, spa: 90, spd: 115, spe: 25},
		abilities: {0: "Analytic", H: "Overcoat"},
		heightm: 1.7,
		weightkg: 50,
		color: "White",
	...
	clockbreaker: {
		...
		name: "Clockbreaker",
		types: ["Psychic"],
		baseStats: {hp: 62, atk: 103, def: 75, spa: 55, spd: 88, spe: 92},
		abilities: {0: "Pendulum", 1: "Own Tempo", H: "Skill Link"},
		heightm: 1.7,
		weightkg: 50,
		color: "Brown",
	...
	clocklizard: {
		...
		abilities: {0: "Soundproof", 1: "Pendulum", H: "Storm Drain"},
		heightm: 1.7,
		weightkg: 50,
		color: "Purple",
	...
	orbital: {
		...
		abilities: {0: "Transmutate", 1: "Trace"},
		heightm: 1.7,
		weightkg: 999.9,
		color: "Blue",
	...
	ancienttroiamon: {
		...
		types: ["Steel", "Ground"],
		gender: "N",
		baseStats: {hp: 120, atk: 155, def: 120, spa: 100, spd: 110, spe: 75},
	...
	divermon: {
		...
		types: ["Water"],
		gender: "N",
		baseStats: {hp: 80, atk: 110, def: 98, spa: 70, spd: 60, spe: 102},
		abilities: {0: "Torrent", 1: "Swift Swim", H: "Sniper"},
		heightm: 0.7,
		weightkg: 20,
		color: "Blue",
		eggGroups: ["Undiscovered"],
